...
hold on
semilogy(1:N,costlist3,'LineWidth',2)
semilogy(1:N,costlist4,'LineWidth',2)
grid on
title("Kostfuncties van verschillende Adam methoden")
xlabel("Iteratie van gekozen methode")
ylabel("Kost")
legend('Adam','Stochastische Adam: t verhogen per hele dataset','Stochastische Adam: t verhogen per exemplaar')